...
public class ImagesManager implements ImagesServices {
    ...
    @Inject
    public ImagesManager(WSClient ws, Configuration configuration, ProductRepository productRepository) {
        this.ws = ws;
    ...
    public CompletionStage<BingResult> searchImageService(String q) {
        final String subscriptionKey = "3a3c89917c9c47728adfc58a6a63097d";
    ...
    public CompletionStage<String> saveImagesToDb(String q) {
        ...
        return productRepository.findByDescription(q).thenApply(lProduct -> {
            try {
