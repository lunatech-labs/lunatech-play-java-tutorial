...
public class Products extends Controller {
    ...
    public Result dbload() {
        ...
        productRepository.loadCsv(csvpath);
    ...
    public CompletionStage<Result> list()  {
        Messages message = play.mvc.Http.Context.current().messages();
        return productRepository.findAll().thenApply(lProducts -> {
    ...
    public Result save() {
        ...
        if (id == 0)
            ...
            try {
                product = productRepository.findById(id).toCompletableFuture().get();
