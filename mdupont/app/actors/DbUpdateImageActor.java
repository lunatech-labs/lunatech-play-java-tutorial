...
public class DbUpdateImageActor extends UntypedAbstractActor {

    @Inject
    private ProductService productService;

    public static Props getProps() {
        return Props.create(DbUpdateImageActor.class);
    }
    ...
    protected void doUpdateProductWithAnImage(DBUpdateImageActorMsg dbUpdateImageActorMsg) {
        ...
        this.productService.findByDescription(dbUpdateImageActorMsg.getDescription())
                .stream()
                .findFirst()
                .ifPresent(product -> {
    ...
    public void onReceive(Object message) throws Throwable {
        if (message instanceof DBUpdateImageActorMsg) {
            ...
            Logger.error("Wrong message type expected by DbUpdateImageActor");
        }
    }
}
